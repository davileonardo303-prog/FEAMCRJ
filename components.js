  ...
  const headerHTML = `
    <header class="sticky top-0 z-50 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-900">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
          ...
          <nav class="hidden lg:flex items-center space-x-1">
            ...
            <a href="cursos.html" class="px-3 py-2 rounded-lg text-sm font-semibold tracking-wide transition-all ${activePage === 'cursos.html' ? 'text-amber-500 bg-amber-500/5' : 'text-zinc-300 hover:text-white hover:bg-zinc-900/50'}">Cursos</a>
      ...
      <div id="mobile-menu" class="hidden lg:hidden border-b border-zinc-900 bg-zinc-950 px-4 pt-2 pb-6 space-y-2">
        ...
        <a href="cursos.html" class="block px-3 py-2 rounded-lg text-base font-semibold ${activePage === 'cursos.html' ? 'text-amber-500 bg-amber-500/5' : 'text-zinc-300 hover:bg-zinc-900'}">Cursos Oficiais</a>
